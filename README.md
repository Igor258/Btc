...
<style type="text/css">
    .tgbox{width: 50px;height: 50px;position: fixed;bottom: 170px;right: 30px;z-index: 99; }
    .breathe-div {width: 50px;height: 50px;position: fixed;border: 1px solid #2b92d4;border-radius: 50%;
        text-align: center;cursor: pointer;box-shadow: 0 1px 2px rgba(0, 0, 0, 0.3);overflow: hidden;
        -webkit-animation-timing-function: ease-in-out;-webkit-animation-name: breathe;
        -webkit-animation-duration: 1000ms;-webkit-animation-iteration-count: infinite;-webkit-animation-direction: alternate; }
    @-webkit-keyframes breathe {
        0% {opacity: 1;box-shadow: 0 1px 2px rgba(0, 147, 223, 0.4), 0 1px 1px rgba(0, 147, 223, 0.1) inset;scale: none;}
        100% {opacity: 1;border: 1px solid rgba(59, 235, 235, 0.7);box-shadow: 0 1px 30px #0093df, 0 1px 20px #0093df inset;scale: 1.5;}
    }
</style>
<div class="tgbox" data-toggle="tooltip" data-placement="left" title="Telegram Service">
    <a href="https://t.me/BtcMiningvip" target="_blank">
        <div class="breathe-div"><img src="/assets/images/telegram.png"></div>

    </a>
</div>

    <footer class="css-footer css-footer-fixed">
        <a href="#" class="css-tabBar-item">
            <span class="css-tabBar-item-icon"><i class="las la-home"></i></span>
            <span class="css-tabBar-item-text">About</span>
        </a>
        <a href="#" class="css-tabBar-item">
            <span class="css-tabBar-item-icon"><i class="las la-fingerprint"></i></span>
            <span class="css-tabBar-item-text">Teams</span>
        </a>

        <a href="#" class="css-tabBar-item ">
            <span class="css-tabBar-item-icon">	<i class="las la-hammer"></i></span>
            <span class="css-tabBar-item-text">Mining</span>
        </a>

        <a href="#" class="css-tabBar-item ">
            <span class="css-tabBar-item-icon"> <i class="las la-comment-dots"></i></span>
            <span class="css-tabBar-item-text">Ticket</span>
        </a>
        <a href="#" class="css-tabBar-item ">
            <span class="css-tabBar-item-icon"><i class="las la-user"></i></span>
            <span class="css-tabBar-item-text">Dashboard</span>
        </a>
    </footer>


<!-- jquery -->
<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="/assets/templates/basic2/js/jquery-3.3.1.min.js"></script>
<!-- migarate-jquery -->
<script src="/assets/templates/basic2/js/jquery-migrate-3.0.0.js"></script>
<!-- bootstrap js -->
<script src="/assets/templates/basic2/js/bootstrap.min.js"></script>
<script src="/assets/templates/basic2/js/swiper.min.js"></script>
